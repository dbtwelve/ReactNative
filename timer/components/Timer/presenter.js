...
class Timer extends Component{
    componentWillReceiveProps(nextProp){
        ...
        if(!currentProps.isPlaying && nextProp.isPlaying){
        ...
        } else if(currentProps.isPlaying && !nextProp.isPlaying){
            clearInterval(this.state.timerInterval)
        }
        //console.log(`The current props are: ${currentProps.isPlaying} and the new ones are ${nextProp.isPlaying}`);
    }
